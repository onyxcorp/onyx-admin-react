...
StoreHeader = React.createClass({

    displayName: 'StoreHeader',
    ...
    _handleMiniCartClick: function () {
        this.context.router.transitionTo('confirm');
    },
    ...
    render: function () {
        ...
        var naming;
        // var old = (
        //     <a className='clickable' id='header-menu'><Avatar size={40} user={this.props.user} /> </a>
        // );
